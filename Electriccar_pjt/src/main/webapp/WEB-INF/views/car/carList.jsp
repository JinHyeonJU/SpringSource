...
<head>
    ...
    <!-- RANGE SLIDER -->
    <link href="/resources/assets/vendor/range-slider/range-slider.css" rel="stylesheet">
    <!-- OWL CAROUSEL  --> 
            ...
            <div class="col-12 col-sm-2 col-lg-5">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu p-0 fables-forth-background-color rounded-0 m-0 border-0 lang-dropdown" aria-labelledby="dropdownLangButton">
                        ...
                        <img src="/resources/assets/custom/images/england.png" alt="england flag" class="mr-1"> English</a>
                        <a class="dropdown-item white-color font-13 fables-second-hover-color" href="#">
                        <img src="/resources/assets/custom/images/France.png" alt="england flag" class="mr-1"> French</a> 
                  </div>
                </div>
               ...
               <div class="row">
                   <div class="col-12 col-md-10 col-lg-9 pr-md-0">                       
                       <nav class="navbar navbar-expand-md btco-hover-menu py-lg-2">
                            ...
                            <a class="navbar-brand pl-0" href="index.html"><img src="/resources/assets/custom/images/fables-logo.png" alt="Fables Template" class="fables-logo"></a>
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <div class="p-3 cart-block">
                                             ...
                                             <div class="row mx-0 mb-3">
                                                 <div class="col-4 p-0">
                                                     <a href="#"><img src="/resources/assets/custom/images/sml1.jpg" alt="" class="w-100"></a>
                                                 </div>
                                                 <div class="col-8">
...
<div class="container py-3 py-lg-5">
       ...
       <div class="row">
            <div class="col-6 col-md-3 mb-4 mb-lg-5">
                <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                  <img class="w-100" src="/resources/assets/custom/images/team1-1.jpg" alt="Card image cap">
                  <div class="card-body">
            ...
            <div class="col-6 col-md-3 mb-4 mb-lg-5">
                <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                  <img class="w-100" src="/resources/assets/custom/images/team1-2.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5><a href="#" class="fables-team-name fables-second-hover-color team-name">JOHN MARTIN</a></h5>
                    <p class="fables-team-pos mt-2 mb-3 italic">Programmer</p> 
                    <ul class="nav fables-team-social-links"> 
            ...
            <div class="col-6 col-md-3 mb-4 mb-lg-5">
                <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                  <img class="w-100" src="/resources/assets/custom/images/team1-3.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5><a href="#" class="fables-team-name fables-second-hover-color team-name">JOHN MARTIN</a></h5>
                    <p class="fables-team-pos mt-2 mb-3 italic">Programmer</p> 
                    <ul class="nav fables-team-social-links"> 
            ...
            <div class="col-6 col-md-3 mb-4 mb-lg-5">
                <div class="card fables-team-block fables-team-data-hover fables-second-border-color mb-4 mb-sm-0">
                  <img class="w-100" src="/resources/assets/custom/images/team1-4.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5><a href="#" class="fables-team-name fables-second-hover-color team-name">JOHN MARTIN</a></h5>
                    <p class="fables-team-pos mt-2 mb-3 italic">Programmer</p> 
                    <ul class="nav fables-team-social-links"> 
    ...
    <div class="row">
        <div class="col-6 col-md-3 mb-4 mb-lg-5">
            <div class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
              <div class="image-container shine-effect">
                  <a href="#"><img class="w-100" src="/resources/assets/custom/images/team3-1.jpg" alt="Card image cap"></a> 
              </div>
              <div class="card-body">
        ...
        <div class="col-6 col-md-3 mb-4 mb-lg-5">
            <div class="card fables-team-block fables-second-hover-text-color fables-team-border fables-second-border-color">
               <div class="image-container shine-effect">
                  <a href="#"><img class="w-100" src="/resources/assets/custom/images/team3-2.jpg" alt="Card image cap"></a>
              </div>
              <div class="card-body">
                <h5><a href="#" class="font-20 semi-font fables-forth-text-color fables-second-hover-color team-name">JOHN MARTIN</a></h5>
                <p class="font-13 fables-forth-text-color my-1">Programmer</p> 
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                <a href="#" class="fables-second-border-color border-bottom pb-3 d-block mb-3 mt-minus-13"><img src="/resources/assets/custom/images/fables-logo.png" alt="fables template"></a>
...
<script src="/resources/assets/vendor/jQuery.countdown-master/jquery.countdown.min.js"></script>
...
<script src="/resources/assets/custom/js/jquery-data-to.js"></script>  
